...
enum enTransaction { Deposit = 1, WithDraw = 2, TotalBalnces = 3, MainMenu = 4 };
void TransactionsMaiMenue() {
    cout << "====================================\n";
    cout << "\t Transactions Main Menue Screeb\n";
    cout << "====================================\n";
    cout << "\t [1] Deposit .\n";
    cout << "\t [2] Withdraw .\n";
