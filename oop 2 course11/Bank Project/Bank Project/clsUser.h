...
private:
    ...
    static clsUser _GetEmptyUserObject()
    {
     ...
     string _PrepareLogInRecord(string Seprater="#//#") {
        string LoginRecord = "";
        LoginRecord += clsDate::GetSystemDateTimeString() + Seprater;
        LoginRecord += UserName + Seprater;
        LoginRecord += Password + Seprater;
